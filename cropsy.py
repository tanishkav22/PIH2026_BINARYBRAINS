...
def crop(crop_name: str) -> List[str]:
    crop_data: Dict[str, List[str]] = {
        ...
        "bajra": ["/static/images/bajra.jpg", "Rajasthan, Maharashtra, Haryana, Uttar Pradesh, Gujarat", "kharif", "Oman, Saudi Arabia, Israel, Japan"],
        ...
        "groundnut": ["/static/images/groundnut.jpg", "Andhra Pradesh, Gujarat, Tamil Nadu, Karnataka, Maharashtra", "kharif", "Indonesia, Jordan, Iraq"],
        "arhar": ["/static/images/arhar.jpg", "Maharashtra, Karnataka, Madhya Pradesh, Andhra Pradesh", "kharif", "United Arab Emirates, USA, Chicago"],
        ...
        "niger": ["/static/images/niger.jpg", "Andhra Pradesh, Assam, Chhattisgarh, Gujarat, Jharkhand", "kharif", "United States of America, Argentina, Belgium"],
        "rape": ["/static/images/rape.jpg", "Rajasthan, Uttar Pradesh, Haryana, Madhya Pradesh, Gujarat", "rabi", "Vietnam, Malaysia, Taiwan"],
        ...
        "soyabean": ["/static/images/soyabean.jpg", "Madhya Pradesh, Maharashtra, Rajasthan", "kharif", "Spain, Thailand, Singapore"],
        ...
        "ragi": ["/static/images/ragi.jpg", "Maharashtra, Tamil Nadu, Uttarakhand", "kharif", "United Arab Emirates, New Zealand, Bahrain"],
    ...
    return crop_data.get(crop_name.lower(), ["Not Found"])


def msp(crop_name: str) -> float:
    base: Dict[str, float] = {
        "paddy": 1245.5,
        "arhar": 3200,
        "bajra": 1175,
    ...
    return base.get(crop_name.lower(), 0.0)


# ----------------------------
# Example Run (Python 3.13)
# ----------------------------
if __name__ == "__main__":
    name = input("Enter crop name: ").strip()

    crop_info = crop(name)
    crop_price = msp(name)

    print("\nCrop Info:", crop_info)
    print("MSP:", crop_price)